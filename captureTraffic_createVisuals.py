...
def createVisuals(traffic,myIP):
    ...
    for idx,value in chordDF.iterrows():
        chordDF.iloc[idx,chordDF.columns.get_loc('dst-ipcode')] = ipcatmapping[ipcatmapping['ip'] == chordDF.iloc[idx,chordDF.columns.get_loc('dst-ip')]]['code']
        chordDF.iloc[idx,chordDF.columns.get_loc('src-ipcode')] = ipcatmapping[ipcatmapping['ip'] == chordDF.iloc[idx,chordDF.columns.get_loc('src-ip')]]['code']
